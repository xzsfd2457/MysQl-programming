...
insert into employee(name,age,address,salary,gen) values ("khilan",  "25","delhi","1500",'n');
...
insert into employee(name,age,address,salary,gen) values ("komal",   "22","mp","4500",'n');
insert into employee(name,age,address,salary,gen) values ("muffy",   "24","indore","10000",'m');
select * from employee where gen in ('m','f');
